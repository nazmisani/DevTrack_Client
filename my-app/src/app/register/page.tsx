  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-black text-white">
      ...
      <div className="absolute w-full h-full overflow-hidden z-0">
        ...
        <div className="absolute top-1/3 left-1/3 w-96 h-96 bg-cyan-700 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>        {/* Code-like background decoration */}
